...
class Studentfacilities extends Component {
  ...
  getFacilitydata()
  {
    ...
    axios.get('https://formeeadmin.bicsglobal.com/get_facility/'+localStorage.getItem('universityid')+'/student').then(response => {
                  ...
                  <Card className="uni-right-card">
                    ...
                    <CardBody>
                      <FormGroup className="uni-para-content">
                          ...
                          <textarea class="form-control" ref="description" value={this.state.description} onChange={this.handleDescriptionChange} id="txtsdescription" placeholder="" rows="20" required>

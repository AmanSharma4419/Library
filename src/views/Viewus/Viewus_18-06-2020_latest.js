      ...
      <div className="animated fadeIn gray-bg-300">
        ...
        <div className="container-fluid px-0">
			...
			<ul className="nav nav-tabs filter-btn" id="" role="">
                ...
                <li className="nav-item">
                  <a className="nav-link" data-toggle="tab" href="#Facility1" role="tab" > Facilities</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" data-toggle="tab" href="#Campus1" role="tab">Campuses </a>
                </li>
                {/*<li className="nav-item">
                  <a className="nav-link" data-toggle="tab" href="#Entry1" role="tab" > Entry Requirements</a>
                </li>*/}
                <li className="nav-item">
                  <a className="nav-link" data-toggle="tab" href="#Contactus1" role="tab" > Contact </a>
                </li>
                <li className="nav-item">
					...
					<a className="col-12 backarrow mt-3" href="#/profile"><span className="pr-1"> <img src={backarrow} alt="" /></span> Back </a>
					 ...
					 <div className="col-md-6 about-left-block">
						...
						<div className="col-md-12 left-cont-heg px-0">
								{( (this.state.about != null && this.state.about.description != '') ? (<p>{this.state.about.description}</p>):(<p></p>) )}
					 ...
					 <div className="col-md-6 about-right-block px-0 text-right">
						...
						{( (this.state.about != null && this.state.about.filename != '') ? (<img src={imgpath+this.state.about.filename} width="450" height="604" />):(<p></p>) )}
					 ...
					 {this.state.aboutsub.map(aboutsub => (
						...
						<div className="col-md-6 px-0 stud-hub-left">
							...
							{(aboutsub.layout == 'right' ? (<p><h2>{aboutsub.heading}</h2>{aboutsub.description}</p>):(<img src={imgpath+aboutsub.filename} width="555" height="527" alt="" />) )}
						</div>

						<div className="col-md-6 stud-hub-right0">
							{(aboutsub.layout == 'right' ? (<img src={imgpath+aboutsub.filename} width="555" height="527" alt="" />):(<p><h2>{aboutsub.heading}</h2>{aboutsub.description}</p>) )}
						</div>
					 ...
					 <div className="col-md-12 about-facility px-0">
						<div className="col-md-8 mx-auto text-center">
							...
							{( (this.state.facility != null && this.state.facility.description != '') ? (<p>{this.state.facility.description}</p>):(<p></p>) )}
					 ...
					 <div className="col-md-12 about-uni-section mt-5 row mx-0">
						<div className="col-md-6 about-uni-left px-0">
							...
							{( (this.state.facilityuniversity != null && this.state.facilityuniversity.description != '') ? (<p>{this.state.facilityuniversity.description}</p>):(<p></p>) )}
					 ...
					 <div className="col-md-12 about-stud-left mt-5 row mx-0">
						<div className="col-md-6 px-0">
							...
							{( (this.state.facilitystudent != null && this.state.facilitystudent.description != '') ? (<p>{this.state.facilitystudent.description}</p>):(<p></p>) )}
            ...
            <div class="col-md-12">
              <div className="col-md-6">
                ...
                <p>{campussub.sub_heading}</p>
						...
						*/}
					 {/* contact us */}
					 <div className="uni-contact-box w-100">
							<div className="row">

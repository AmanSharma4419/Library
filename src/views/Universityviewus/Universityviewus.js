...
class Universityviewus extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="animated fadeIn gray-bg-300">
        ...
        <div className="container-fluid px-0">
			...
			<div className="container-fluid univiewus px-0">
				<div className="container">
                ...
                <div className="tab-pane active" id="About1" role="tabpanel">
                  ...
                  <div className="col-md-12 about-section mx-0 px-0 row">
					<a className="col-12 backarrow mt-3" href="#/profile"><span className="pr-1"> <img src={backarrow} alt="" /></span> Back </a>
					 <h1 className="col-md-12 about-title mt-4 mb-3">PROGRAMS </h1>
							...
							<table className="table">
							  <tbody>
								<tr>
								  ...
								  Bachelor of Arts - Business Administration - Management - Human
Resource Management
...
export default Universityviewus;

...
//alert(id);
			axios.get(baseurl + "/get_agentdetails/" + id).then((response) => {
			...
			// }
				...
				var agent_id=localStorage.getItem('agentid');
			axios.get(baseurl + "/get_agent_student_reviews_byagentid/" + agent_id).then((response) => { 
			this.setState({
			items: response.data,
    ...
    handleChangeone(e) {
     ...
     handleSubmit(e) {
        ...
        const products = {
            ...
            let uri =baseurl +'/store_agent_student_reviews';
      ...
      <div className="top-section">
        ...
        <div className="container mb-5">
          ...
          <div className="col-md-10 col-lg-8 col-12 leave-review mx-auto">
              ...
              <div className="content-block mt-3 partner-info row mx-0 col-lg-9 col-12">
			    
                <div className="col-md-4 my-4">
             
                  <img src={imgpath + "/Agent/" + this.state.agentdetails.company_logo}  alt="" />{" "}
                </div>
    ...
    ) : overall_review.toFixed() == 4 ? (<img src={rating} alt="" />)
	:overall_review.toFixed() == 3 ? (<img src={ratingthree} alt="" />)
	:overall_review.toFixed() == 2 ? (<img src={ratingtwo} alt="" />)
	:  (<img src={ratingone} alt="" />)
              ...
              <div className="col-lg-10 col-12 px-0 px-lg-3 row">
                  <div className="col-lg-2 col-12 px-0">
                    <label className="card-label">Your review</label>
                   </div>
				   
                   <div className="col-lg-10 mx-auto col-sm-10 col-md-8 col-12 px-0 px-lg-3"> 
				   <div onChange={this.handleLayoutChange} >
				       	  <div className="col-12 mb-1">
					 
                        <div class="custom-control custom-checkbox">
                          <input type="radio" name="star"  required  value="5"      class="custom-control-input"    name="example1" />
                          <label class="custom-control-label" for="customCheck"><img src={ratingfive} alt="" /> </label> 5 Excellent
                        </div>
                      </div>
                      <div className="col-12 mb-1">
                        <div class="custom-control custom-checkbox">
                          <input type="radio" name="star"    checked={this.state.selectedOption === "4"}   class="custom-control-input" value="4"  name="example1" />
                          <label class="custom-control-label" for="customCheck"><img src={rating} alt="" />  </label> 4 Very good
                        </div>
                      </div>
                      <div className="col-12 mb-1">
                        <div class="custom-control custom-checkbox">
                          <input type="radio" name="star" onChange={this.handleChange}  checked={this.state.selectedOption === "3"} class="custom-control-input"    value="3" name="example1" />
                          <label class="custom-control-label" for="customCheck"><img src={ratingthree} alt="" />  </label> 3 Average
                        </div>
                      </div>
                      <div className="col-12 mb-1">
                        <div class="custom-control custom-checkbox">
                          <input type="radio" name="star"  onChange={this.handleChange}  checked={this.state.selectedOption === "2"} class="custom-control-input" value="2"   name="example1" />
                          <label class="custom-control-label" for="customCheck"><img src={ratingtwo} alt="" />  </label> 2 Poor
                        </div>
                      </div>
                      <div className="col-12 mb-1">
                        <div class="custom-control custom-checkbox">
                          <input type="radio" onChange={this.handleChange}  name="star" checked={this.state.selectedOption === "1"}  class="custom-control-input" value="1"   name="example1" />
                          <label class="custom-control-label" for="customCheck"><img src={ratingone} alt="" /> </label> 1 Terrible
                        </div>
                      </div>
              ...
              <div className="">
                  <div className="">
                    <label className="card-label">Your review</label>
                    <textarea id ="review" name ="review"  onChange={this.handleChangeone} className="form-control w-100 checksame" id="" placeholder="Write a review..." name=""></textarea>
                  </div>
              </div>
              </div>
              <hr className="review-subactor" />
              <div className="text-center pb-4">
                ...
                <a href="#/preferedpartnerabout/" className="mt-4 d-block">Delete Review</a>
              </div>

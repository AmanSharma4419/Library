...
class Librarygeneral extends Component {
  ...
  constructor(props) {
	...
	axios.get(baseurl_loc+'getLibraryFolders/1').then(response => {	
...
{ 
	...
	return <div className="col-md-4 col-lg-4 col-xl-4 lib-box mt-3">
					   ...
					   <a href={baseurl_file+'Library/'+schema}  id='down_img' download><img class="mr-3" src={baseurl_file+'Library/'+schema} alt="file name"/></a>
...
handleClickDownload(param) 
{
	...
	const products ={
		file: param,
		file_name: original_files,
		}	
	let uri = baseurl+'/download_file';
		  ...
		  <Col xs="12" sm="12" xl="3" md="12" lg="3">
              <Card className="uni-left-card">
                ...
                <ListGroup className="left-list">
					<Link to="Librarygeneral"><ListGroupItem  className="active">General Resources</ListGroupItem></Link>
			  ...
			  <Card className="uni-left-card mt-3 lib-left">
                <CardBody>
                <ListGroup className="left-list">
					<Link to="Libraryvideo"><ListGroupItem>Video Tutoring Resources</ListGroupItem></Link>
					<Link to="Libraryieltsvid"><ListGroupItem>IELTS</ListGroupItem></Link>
					<Link to="Librarygmatvid" ><ListGroupItem >GMAT</ListGroupItem></Link>

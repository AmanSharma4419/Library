...
class Librarygeneral extends Component {
  ...
  constructor(props) {
	...
	axios.get(baseurl_loc+'getLibraryFolders/2').then(response => {	
		...
		<ToastContainer />
		  ...
		  <Col xs="12" sm="12" xl="3" md="12" lg="3" >
			  ...
			  <Card className="uni-left-card mt-3 lib-left">
                <CardBody>
                <ListGroup className="left-list">
					<Link to="Libraryvideo"><ListGroupItem  className="active">Video Tutoring Resources</ListGroupItem></Link>

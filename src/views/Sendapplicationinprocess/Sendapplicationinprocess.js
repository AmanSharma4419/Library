...
class Sendapplicationinprocess extends Component {
  constructor(props) {
    super(props);
  ...
  getGeneraldata() {
    axios
      ...
      .then((response) => {
        ...
        let fileNames = [];
        res.data.forEach(({orgfilename}) => fileNames.push(orgfilename))
        fileNames = fileNames.concat(response.data.org_stu_doc)  
        console.log("org res", fileNames)
          this.setState(
            {
              org_stu_doc: fileNames
            });
        })
        ...
        this.setState({
          ...
          stu_education:
            response.data.stu_education != null
              ? response.data.stu_education
              : "",
          stu_testscore:
            response.data.stu_testscore != null
              ? response.data.stu_testscore
              : "",
          stu_bginfo:
            response.data.stu_bginfo != null ? response.data.stu_bginfo : "",
          stu_documents: response.data.stu_documents,
          eduhis: response.data.eduhis,
          docs: response.data.docs,
          pers: response.data.pers,
          trans: response.data.trans,
          universitydetails: response.data.universitydetails,
          getdetails: response.data.getdetails,
          stu_doc: response.data.stu_doc != null ? response.data.stu_doc : "",
          
        });
        localStorage.setItem(
          "universityid",
          this.state.universitydetails.university_id
        );
        localStorage.setItem(
          "university_logo",
          this.state.universitydetails.logo_image
        );
        localStorage.setItem(
          "university_name",
          this.state.universitydetails.institute_name
        );
      });
    ...
    // alert(stdid);
    axios
      .get(baseurl + "/get_answer/" + param + "/" + stdid + "/general")
      .then((response) => {
    ...
    axios
      .get(baseurl + "/get_answer/" + param + "/" + stdid + "/education")
      .then((response) => {
        console.log("QuestionPattern" + response);
        ...
        this.setState({ education: questionArr });
      });

    axios
      .get(baseurl + "/get_answer/" + param + "/" + stdid + "/test")
      .then((response) => {
        console.log("QuestionPattern" + response);
        ...
        this.setState({ testscore: questionArr });
      });
    axios
      .get(baseurl + "/get_answer/" + param + "/" + stdid + "/background")
      .then((response) => {
        console.log("QuestionPattern" + response);
        ...
        this.setState({ background: questionArr });
      });
  }
  ...
  render() {
    ...
    console.log(this.state.question, "checking question");
                ...
                <Card className="uni-left-card">
                  <CardBody>
                    <ListGroup>
                      ...
                      <ListGroupItem>
                        <a href="/#/applications">Enrollment Form</a>
                      </ListGroupItem>
                      <ListGroupItem>
                        <a
                          href={
              ...
              >
                <Row className="mx-0">
                  ...
                  <div className="col-md-3 right-btn-align search-icon">
                    ...
                    <div className="col-md-12 right-btn-align search-icon justify-content-end add-view-btn">
                      <div className="upload-btn-wrapper row mb-2 ml-0">
                        {localStorage.getItem("fromApplicationType") !==
                        null ? (
                          localStorage
                ...
                <Card className="uni-left-card app-inprogress">
                  <CardBody className="pr-0">
                    {/**buttons &images **/}
                    <div className="col-12">
                      <div class="col-9 mt-3 float-right row"></div>
                    </div>
                    ...
                    <div class="col-12 Clearfix view-prof-detail">
                      <h3 className="Clearfix">
                        <img
                          src={
                            imgpath + this.state.universitydetails.logo_image
                          }
                          width="50px"
                          alt=""
                        />
                      </h3>
                      <h5 className="mb-4 app-sub-heading">
                        {this.state.universitydetails.institute_name}
                      </h5>
                    ...
                    <div className="col-12 mt-3">
                      <div className="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7 row">
                        <div className="pl-0 col-6">
                          ...
                          >
                            <option value="">
                              {this.state.getdetails.course_startdate}
                            </option>
                          </select>
                        </div>
                        <div className="col-6">
                          <label className="card-label">status:</label>
                          {this.state.getdetails.status == "2" ? (
                            <Button className="newappinprocess">
                              In process
                            </Button>
                          ) : this.state.getdetails.status == "3" ? (
                            <Button className="newappapproved">Approved</Button>
                          ) : this.state.getdetails.status == "4" ? (
                            <Button className="newapprejected">Rejected</Button>
                          ) : this.state.getdetails.status == "9" ? (
                            <Button className="newappdeclined">Declined</Button>
                          ) : this.state.getdetails.status == "6" ? (
                            <Button className="newapppayment">
                              Payment Pending
                            </Button>
                          ) : this.state.getdetails.status == "7" ? (
                            <Button className="newapppaid">Paid</Button>
                          ) : (
                            <></>
                          )}
                        </div>
                                    ...
                                    >
                                      <div className="card-body">
                                        <div className="row view-app-detail">
                                          ...
                                          <div className="col-12 col-sm-8 col-lg-8 col-md-8 col-xl-8 view-app-right">
                                            {this.state.stu_personal.addr_email}
                                          </div>
                                          <div className="col-12 col-sm-3 col-lg-3 col-md-3 col-xl-3 view-app-left">
                                            Primary Email :
                                          </div>
                                    ...
                                    >
                                      <div className="card-body">
                                        <div className="row view-app-detail">
                                          ...
                                          <div className="col-12 col-sm-8 col-lg-8 col-md-8 col-xl-8 view-app-right">
                                            {this.state.stu_testscore.exam_type}
                                          </div>
                                          <div className="col-12 col-sm-3 col-lg-3 col-md-3 col-xl-3 view-app-left">
                                            Exam Date :
                                          </div>
                                          <div className="col-12 col-sm-8 col-lg-8 col-md-8 col-xl-8 view-app-right">
                                            {this.state.stu_testscore.exam_date}
                                          </div>
                                          <div className="col-12 col-sm-12 col-lg-12 col-md-12 col-xl-12">
                                            <b>Input Exact Scores</b>
                                          </div>
                                  ...
                                  <div className="card">
                                    ...
                                    >
                                      <div className="card-body">
                                        <b>
                                          {" "}
                                          Have you been refused a visa from
                                          Canada, the USA, the United Kingdom,
                                          New Zealand or Australia?{" "}
                                        </b>
                                        <br />
                                        {this.state.stu_bginfo.refused_visa ==
                                        "1" ? (
                                          <p>Yes</p>
                                        ) : (
                                          <p>No</p>
                                        ...
                                        <b>
                                          ...
                                          following questions above, please
                                          provide more details below: ?
                                        </b>
                                        <br />
                                        {this.state.stu_bginfo.details}
                                        <br />
                                        <div className="row view-app-detail">
                                          <div className="col-12 col-sm-3 col-lg-3 col-md-3 col-xl-3 view-app-left">
                                            {this.state.background.map(
                                              (data, index) =>
                                  ...
                                  this.state.getdetails.status == "7" ? (
                                    <div className="card">
                                      ...
                                      >
                                        <div className="card-body">
                                          <a
                                            className="viewoffer justify-content-start"
                                            onClick={this.apply}
                                          >
                      ...
                      <a
                        ...
                        href="/#/Applicationfeedbacksent"
                      >
                        <Button>View Application Response</Button>
                      </a>
                    </div>
                  </CardBody>
                </Card>
...
export default Sendapplicationinprocess;

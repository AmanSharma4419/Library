...
function BackgroundAddMore() {
  ...
  return (
    <div className="Addmore backAddmore">
      ...
      <div className="col-12 per-box py-4">
        ...
        {this.state.questionsattended.map((data, index) =>
          <div className="destination-box format">
			...
			<h2 className="uni-label">{this.state.handlequestion[index]}</h2>
			 <Input
                        type="text"
                        className=""
			 ...
			 <Input type="select" id="edulevel"   onChange={(evt) => this.handleQuestionName(evt, index)} className=" edulevel" >
			...
			<div> <h2 className="uni-label">{this.state.handlequestion[index]}</h2> 
			 ...
			 <Input type="select" id="edulevel" onChange={(evt) => this.handleQuestionName(evt, index)} className="multiple-select edulevel" multiple>
                          <option value="">Select</option>

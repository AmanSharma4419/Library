     ...
     <div className="row">
          ...
          <div className="col-12 per-box py-4">
                ...
                <div className="row">
                     <div className="col-md-6">
                        <FormGroup>
                            ...
                            <Input type="select" id="examtype" onChange={this.handleExamtypeChange}>
           ...
           <div className="pr-header">
                  ...
                  <div className="row uni-no-mar">
                    <div className="col-md-3 uni-no-padd no-br">
                        <FormGroup>
                          ...
                          <Input type="number" className="form-control" placeholder="Enter Scores"
                 ...
                 <label className="form-check-label">I don’t have any test scores</label>
              </div>
           ...
           <div className="personal-box-inner score-mark-box">
                    ...
                    <Label className="uni-label">Verbal</Label>
                      <div className="score-list flex-column">
                       <div className="score-name border-gray">
                             ...
                             <Input type="number" className="form-control" value={this.state.greverbalscore} 
                       ...
                       <div className="score-name">
                             ...
                             Rank %
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.greverbalrank} 
                      ...
                      <div className="score-list flex-column">
                       <div className="score-name border-gray">
                             ...
                             Score
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.grequanitativescore} 
                       ...
                       <div className="score-name">
                             ...
                             Rank %
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.grequanitativerank} 
                      ...
                      <div className="score-list flex-column">
                       <div className="score-name border-gray">
                             ...
                             Score
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.grewritingscore} 
                       ...
                       <div className="score-name">
                             ...
                             Rank %
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.grewritingrank} 
             ...
             <div className="form-check my-3">
              <input type="checkbox" className="form-check-input" value="1" id="greCheck" onChange={this.handleGrecheckChange} />
                      ...
                      <div className="score-list flex-column">
                       <div className="score-name border-gray">
                             ...
                             Score
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.gmatverbalscore} 
                       ...
                       <div className="score-name">
                             ...
                             Rank %
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.gmatverbalrank} 
                      ...
                      <div className="score-list flex-column">
                       <div className="score-name border-gray">
                             ...
                             Score
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.gmatquanitativescore} 
                       ...
                       <div className="score-name">
                             ...
                             Rank %
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.gmatquanitativerank} 
                      ...
                      <div className="score-list flex-column">
                       <div className="score-name border-gray">
                             ...
                             Score
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.gmatwritingscore} 
                       ...
                       <div className="score-name">
                             ...
                             Rank %
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.gmatwritingrank} 
                      ...
                      <div className="score-list flex-column">
                       <div className="score-name border-gray">
                             ...
                             Score
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.gmattotalscore} 
                       ...
                       <div className="score-name">
                             ...
                             Rank %
                               ...
                               <div className="score-in">
                             <Input type="number" className="form-control" value={this.state.gmattotalrank} 
          ...
          <Button color="primary" className="score-back mx-4" data-toggle="tab" href="#tab2" role="tab">BACK</Button>

...
class Landingpages extends Component {
  ...
  constructor(props) {
   ...
   this.state = {
	...
	axios.get(baseurl+'/get_landingpagedetails/'+param).then(response => {
	...
	axios.get(baseurl+'/get_categories').then(response => {
		console.log(response);
         this.setState({
 ...
 handleChange = param => e => {
	 var unv_id = localStorage.getItem('universityid');	
	axios.get(baseurl+'/get_batchcourses/'+unv_id+'/'+param).then(response1 => {
		this.setState({
                   cou: response1.data.batchcourse
               });
                  ...
                  <div className="col-md-12 pt-4 row uni-dashboard-left">
					...
					<div className="col-md-3 text-center">
					 ...
					 <div className="col-md-3 text-center">
						...
						<NavLink to="#" href="#/landingpages" className="nav-link">
						  <div className="badge-container">
						  <Badge color="danger" onClick={this.handleChange('1')}>BG</Badge>
						  <Badge color="info" onClick={this.handleChange('2')}>PG</Badge>
						  <Badge color="warning" onClick={this.handleChange('3')}>VOC</Badge>
						  <Badge color="primary" onClick={this.handleChange('4')}>DOC</Badge>
						  </div>
						  </NavLink>
					  </NavItem>
						<ul>
